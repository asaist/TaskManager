...
public class TXTFileWork implements FileWork {
    ...
    private static final String tasksStorageFileName="server/textFile/tasksStorageFileName.txt";

    ClientTaskManagerModelImpl model;

    public TXTFileWork(ClientTaskManagerModelImpl model) {
        this.model = model;
    }
